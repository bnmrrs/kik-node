...
3. Configure your bot as described in the [documentation](dev-kik-configuration-url)
...
[dev-kik-configuration-url]: https://dev.kik.com/#/docs/messaging#configuration
